      ...
      <section className="w-full min-h-screen">
        <div className="min-w-full h-20 bg-[#FCFAFA] flex items-center m-auto  justify-around">
          <p className="w-3/4 text-center italic text-gray-500">
            Quando buscamos a excelência, não temos limites para atingir aquilo
            que parece impossivel aos outros!
          </p>
          ...
          <div className="h-auto w-full flex flex-col justify-between">
            <div className="p-8 flex flex-col gap-4">
              ...
              <p>
                ...
                error fugiat necessitatibus labore aperiam, incidunt distinctio
                repellendus numquam consequatur eaque? Eveniet nostrum
                consectetur beatae odit fugiat quia tempore repellendus nobis.
              </p>
            </div>
